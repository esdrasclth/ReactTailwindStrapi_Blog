  ...
  return (
    <div className="w-full bg-[#02044a] text-gray-300 py-8 px-2">
        <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8">
            ...
            <div>
                <h6 className="py-2 font-bold uppercase">Solutions</h6>
                <ol>
        ...
        <div className="flex flex-col max-w-[1240px] px-2 py-2 m-auto justify-between sm:flex-row text-center text-gray-500 items-center">
